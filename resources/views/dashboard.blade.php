					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-8 col-sm-7">
							<div class="total_tasks">
								<div class="jobs">
									<h3>complete Jobs</h3>
									<h4>{{ $JobDone}} <span><img src="{!! asset('assets/frontend/img/job.svg') !!}"></span></h4>
								</div>
								<div class="jobs reviews">
									<h3>Reviews</h3>
									<h4>{{$totalRating->totalreview}}<span><img src="{!! asset('assets/frontend/img/reviews.svg') !!}"></span></h4>
								</div>
								<div class="jobs views">
									<h3>This Month Views</h3>
									<h4>{{$totalProfileView}}<span><img src="{!! asset('assets/frontend/img/views.svg') !!}"></span></h4>
								</div>
							</div>
							<div class="revenue">
