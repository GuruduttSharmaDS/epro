							...
							<div class="hire_companies work_history current_task">
								...
								<?php
									...
									<li>
										...
										{{$job->}}, England, United Kingdom
										</h3>
										
										<time class="calen"><img src="{!! asset('assets/frontend/img/cal.svg') !!}" alt="">{{date('d/m/y', strtotime($job->job_start_on))}} - {{date('d/m/y', strtotime($job->job_end_on))}}</time>
										</div>
										<p>
										{{$job->description}}
										</p>
