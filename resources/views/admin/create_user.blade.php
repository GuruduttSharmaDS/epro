            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card mt-5">
                            <div class="card-body">
                                <h4 class="header-title"><span>Add New</span> User</h4>
                                <form class="needs-validation" novalidate="" id="my-form" method="post" action="{{route('saveuser')}}" enctype = "multipart/form-data">
                                    ...
                                    <div class="form-row">
                                       <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="price" name="price" placeholder="Enter price per hour" value="" required="">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="weapon_number" name="weapon_number" placeholder="Enter weapon number" value="">
                                        </div> 
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="weapon_valid_from" name="weapon_valid_from" placeholder="Choose date" value="">
                                        </div> 
                                        <div class="col-md-6 mb-3">

                                            <label for="weapon_valid_upto">Weapon  Valid Upto</label>
                                            <input type="date" class="form-control" id="weapon_valid_upto" name="weapon_valid_upto" placeholder="Choose date" value="">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control" id="about" name="about" placeholder="Enter about yourself" required></textarea>
                                        </div> 
                                         <div class="col-md-6 mb-3">
