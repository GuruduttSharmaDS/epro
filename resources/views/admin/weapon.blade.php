            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card mt-5">
                            <div class="card-body">
                                <h4 class="header-title"><span>Add New</span> Weapon</h4>
                                <form class="needs-validation" novalidate="" id="my-form" method="post" action="{{route('saveweapon')}}">
                                    <div class="form-row">
                                        @if(session("msg"))
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="weapon" name="weapon_name" placeholder="Enter Weapon" value="" required="">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                            <div class="invalid-feedback">
                                                Please provide a valid weapon.
                                            </div>
                                        </div>                                        
                                    </div>
                    ...
                    <div class="col-8 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Weapons</h4>
    ...
    <script>
        $(function() {
            $('#my-dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('/dashboard/weapon_data') }}',
                columns: [
                { data: 'weapon_name', name: 'weapon_name' },
    ...
    <script type="text/javascript">
        $(document).on('click', ".btn-edit", function(){
            debugger;
                ...
                $("#my-form").find('#weapon').val($(this).closest('tr').find('td:eq(0)').text());
        ...
        $(function () {
            ...
            $(document).on("click", ".btn-delete", function () {
                ...
                if (conf) {
                    ...
                    $.post("{{ route('deleteweapon') }}", postdata, function (response) {
                              debugger;
