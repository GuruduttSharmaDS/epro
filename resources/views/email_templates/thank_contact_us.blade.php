          ...
          <tbody>
            <tr>
              <td colspan="2" style="padding: 5px 15px 20px 15px;" align="left">
                <h2 style="font-size: 15px;color: #153654; text-align: justify;">Thank you for contact us</h2>
                <p style="font-size: 11px;text-align: justify;">We will Contact you soon.</p>
              </td>
            </tr>
			<tr>
              <td>
  ...
  <tbody>
    <tr style="background: rgb(22, 60, 94) none repeat scroll 0% 0%; color: rgb(255, 255, 255);" height="45px" valign="middle">
      <td style="padding-left: 2%; padding-right: 2%; border-radius: 0 0 3px 3px" align="left" valign="middle">
        <span style="-webkit-text-size-adjust: none; font-size: 10px; float: left;">Copyright &copy; <?php echo date("Y"); ?> FREELANCEP. All rights reserved</span>
